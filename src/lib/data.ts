...
export const courses: Course[] = [
  { id: 'c1', name: 'Introduction to React', instructorName: 'Charlie Brown', instructorId: '3', academicYear: 2, sections: 10, price: 150, coverImage: 'https://placehold.co/600x400.png', createdAt: new Date('2023-01-10') },
  { id: 'c2', name: 'Advanced NodeJS', instructorName: 'Frank White', instructorId: '6', academicYear: 3, sections: 15, price: 200, coverImage: 'https://placehold.co/600x400.png', createdAt: new Date('2023-02-01') },
  { id: 'c3', name: 'UI/UX Design Principles', instructorName: 'Charlie Brown', instructorId: '3', academicYear: 1, sections: 8, price: 120, coverImage: 'https://placehold.co/600x400.png', createdAt: new Date('2023-03-15') },
  { id: 'c4', name: 'Database Management', instructorName: 'Frank White', instructorId: '6', academicYear: 2, sections: 12, price: 180, coverImage: 'https://placehold.co/600x400.png', createdAt: new Date('2023-04-02') },
  { id: 'c5', name: 'Data Structures & Algorithms', instructorName: 'Frank White', instructorId: '6', academicYear: 2, sections: 20, price: 250, coverImage: 'https://placehold.co/600x400.png', createdAt: new Date('2023-01-20') },
];
